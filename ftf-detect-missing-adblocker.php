...
class FTF_Detect_Missing_Adblocker
{
  ...
  function enqueue_scripts_and_styles()
  {
    ...
    foreach ($scripts as $script) {
      $js_file_path = plugin_dir_path(__FILE__) . "dist/js/$script.js";
      wp_register_script("ftf-dma-$script", plugin_dir_url(__FILE__) . "dist/js/$script.js", array(), filemtime($js_file_path), array(
        "in_footer" => true,
        "strategy"  => "defer",
      ));
      wp_enqueue_script("ftf-dma-$script");
    }
